...
def build_chain():
    ...
    llm = OpenAI(batch_size=5, temperature=0.25, max_tokens=300)
    ...
    prompt_template = """
    The following is a friendly conversation between a Customer support executive and an AI. 
...
if __name__ == "__main__":
    chain = build_chain()
    result = run_chain(chain, "What are the different customer types")
    print(result['answer'])
